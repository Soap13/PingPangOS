...
;-------------------------------------------------------------------------------
		...
		div_int_message    db '===The divisor is zero the tesk will stop!',0x0a,0x0d,0
		key_int_message    db '===You press the keyboard',0x0a,0x0d,0
		section_int_messag db '===The Section is not right, Please check the code...',0x0a,0x0d,0
